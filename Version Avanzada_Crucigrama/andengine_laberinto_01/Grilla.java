//Sistema de coordenadas del crucigrama
...
/**
 * Created by EBERCILLO on 27/05/2015.
 */
public class Grilla {
    ...
    public void generar(){
        ...
        */
        ...
        /*
        wordsHorizontal.add(new Word("EBER","Hola mundo", 0, 0, 0, this, rectangulo, myScene));
        wordsHorizontal.add(new Word("JESUS", "Este es mi segundo nombre", 1, 0, 0, this, rectangulo, myScene));
        wordsHorizontal.add(new Word("APAHUASCO", "Es un apellido que te contradice", 3, 0, 0, this, rectangulo,myScene));
        wordsVertical.add(new Word("ABCDEFEG", "seleccion al azar de caracteres", 0, 0, 1, this, rectangulo, myScene));
        */
    }
    ...
    //guarda solo una referencia de cada celda
    public void registerTouchAreaInScene(){
